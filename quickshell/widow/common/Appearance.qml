...
Singleton {
    ...
    // BLACK WIDOW THEME - Shades of black, brown, red, and white
    m3colors: QtObject {
        property bool darkmode: true
        property bool transparent: false
        
        // Background and surface colors - Black/Brown shades
        property color m3background: "#0d0c0b" // Very dark brown/black
        property color m3onBackground: "#e8e6e3" // Off-white
        property color m3surface: "#12100e" // Dark brown-black
        property color m3surfaceDim: "#0f0d0c" // Slightly darker
        property color m3surfaceBright: "#2a2621" // Brown tint
        property color m3surfaceContainerLowest: "#080706" // Almost pure black
        property color m3surfaceContainerLow: "#161310" // Dark brown
        property color m3surfaceContainer: "#1c1916" // Medium dark brown
        property color m3surfaceContainerHigh: "#26221e" // Brown
        property color m3surfaceContainerHighest: "#312c27" // Light brown
        
        // Surface and text
        property color m3onSurface: "#f5f3f0" // Warm white
        property color m3surfaceVariant: "#3a342e" // Medium brown
        property color m3onSurfaceVariant: "#d6d0ca" // Light warm gray
        property color m3inverseSurface: "#f5f3f0" // Warm white
        property color m3inverseOnSurface: "#26221e" // Brown
        
        // Outline
        property color m3outline: "#8a7f75" // Brown-gray
        property color m3outlineVariant: "#4a433c" // Dark brown
        
        // Shadow and scrim - Black
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        
        // Primary colors - Red shades (Black Widow's signature)
        property color m3surfaceTint: "#c41e3a" // Spider red
        property color m3primary: "#c41e3a" // Bright red
        property color m3onPrimary: "#ffffff" // Pure white
        property color m3primaryContainer: "#2a080e" // Dark red-black
        property color m3onPrimaryContainer: "#ffcdd2" // Light pink/red
        property color m3inversePrimary: "#8b0000" // Dark red
        
        // Secondary colors - Brown/Black shades
        property color m3secondary: "#a89585" // Light brown
        property color m3onSecondary: "#1a1612" // Dark brown
        property color m3secondaryContainer: "#332c25" // Medium brown
        property color m3onSecondaryContainer: "#e5d9cf" // Light cream
        
        // Tertiary colors - Red/Brown mix
        property color m3tertiary: "#c67c64" // Reddish brown
        property color m3onTertiary: "#1f0f09" // Very dark brown-red
        property color m3tertiaryContainer: "#3c2118" // Dark reddish brown
        property color m3onTertiaryContainer: "#ffd9cf" // Light reddish cream
        
        // Error colors - Deep red
        property color m3error: "#ba1a1a" // Error red
        property color m3onError: "#ffffff" // White
        property color m3errorContainer: "#410002" // Very dark red
        property color m3onErrorContainer: "#ffdad6" // Light pink
        
        // Fixed colors
        property color m3primaryFixed: "#ffdad8" // Light red
        property color m3primaryFixedDim: "#ffb3b0" // Medium light red
        property color m3onPrimaryFixed: "#2a080e" // Dark red-black
        property color m3onPrimaryFixedVariant: "#8c1d2e" // Medium red
        
        property color m3secondaryFixed: "#e5d9cf" // Light cream
        property color m3secondaryFixedDim: "#c9bdb3" // Medium cream
        property color m3onSecondaryFixed: "#1a1612" // Dark brown
        property color m3onSecondaryFixedVariant: "#4d443b" // Medium brown
        
        property color m3tertiaryFixed: "#ffd9cf" // Light reddish cream
        property color m3tertiaryFixedDim: "#e6bfb5" // Medium reddish cream
        property color m3onTertiaryFixed: "#1f0f09" // Very dark brown-red
        property color m3onTertiaryFixedVariant: "#5c3a2d" // Medium reddish brown

        property color workspaceActive: "#c41e3a" // Red for active workspace
        property color workspaceInactive: "#a89585" // Light brown for inactive windows
        property color workspaceEmpty: "#4a433c" // Dark brown for empty workspace

        property color workspaceActiveBright: "#ff4d6d" // Bright Red
        property color workspaceInactiveBright: "#c9bdb3" // Bright Brown
        property color workspaceEmptyBright: "#8b7355" // Bright Dark Brown

        property color colSuccessContainer: ColorUtils.mix(m3colors.m3successContainer, colLayer0, 0.3)
        property color colOnSuccessContainer: m3colors.m3onSuccessContainer

        // Success - Red/Black theme
        property color m3success: "#8b4513" // Saddle brown (success in this theme)
        property color m3onSuccess: "#ffffff" // White
        property color m3successContainer: "#2c1a0a" // Dark brown
        property color m3onSuccessContainer: "#e6d5c3" // Light brown
        
        // Terminal colors - Black, Brown, Red, White palette
        property color term0: "#0d0c0b" // Background black
        property color term1: "#c41e3a" // Red
        property color term2: "#8b4513" // Brown
        property color term3: "#a52a2a" // Red-brown
        property color term4: "#654321" // Dark brown
        property color term5: "#dc143c" // Crimson
        property color term6: "#d2691e" // Chocolate
        property color term7: "#e8e6e3" // Foreground white
        property color term8: "#1c1916" // Bright black
        property color term9: "#ff4d6d" // Bright red
        property color term10: "#cd853f" // Bright brown
        property color term11: "#ff6b6b" // Bright red-pink
        property color term12: "#8b7355" // Bright brown
        property color term13: "#ff3333" // Bright red
        property color term14: "#d2b48c" // Tan
